...
- **No package-specific changes were recorded; `monostyle_metrics` was updated to 0.3.4 as part of group `release`.**

## [0.3.3](https://github.com/ifiokjr/monostyle/releases/tag/v0.3.3) (2026-09-24)

### Changed

- **No package-specific changes were recorded; `monostyle_metrics` was updated to 0.3.3 as part of group `release`.**
